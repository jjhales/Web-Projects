<!-- picks week 16 -->
	<style>
		...
		*/
		...
		$(function(){
			$d = new Date();
			$game1 = new Date(2015, 11, 24, 20, 25, 00, 00);
			$game2 = new Date(2015, 11, 26, 20, 25, 00, 00);
			$game3 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game4 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game5 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game6 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game7 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game8 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game9 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game10 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game11 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game12 = new Date(2015, 11, 27, 13, 00, 00, 00);
			$game13 = new Date(2015, 11, 27, 16, 25, 00, 00);
			$game14 = new Date(2015, 11, 27, 16, 25, 00, 00);
			$game15 = new Date(2015, 11, 27, 20, 30, 00, 00);
			$game16 = new Date(2015, 11, 28, 20, 30, 00, 00);
...
//show winner reconcile
		...
		?>
		   ...
		   <div class="container-fluid" id="week16_Picks">
		  	<div>
				<h3 style="font-family:Copperplate Gothic;margin-left:10px;float:left;">Week 16 Matchups</h3>
			</div>
			...
			<?php
				...
				echo "'>"; //validates
				echo "<input type='hidden' name='week_number' value='16'>";
		//Thursday matchups
				echo "<div id='thurs_games' style='clear:both;'>";
				echo "<h4><u>Thursday December 24, 2015</u></h4>";
				//game1
		...
		//Saturday matchups
				...
				echo "<h4><u>Saturday December 26, 2015</u></h4>";
				//game2
				echo '<div class="match" style="float:left;">';
		...
		//Sunday matchups
				...
				echo "<h4><u>Sunday December 27, 2015</u></h4>";
				//game2
			...
			//Monday Matchups	
				...
				echo "<h4><u>Monday December 28, 2015</u></h4>";
				//game16
				echo '<div class="match" style="float:left">';
