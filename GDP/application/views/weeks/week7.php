<!-- picks week 7 -->
<!-- The first Sunday game of this week is being played at 9:30 AM in London!  Need to annotate this some how -->
	<style>
		body{
		max-width: 100%;
		...
		*/
		...
		.match{
			...
			$(function(){
			$d = new Date();
			$game1 = new Date(2015, 9, 22, 20, 25, 00, 00);
			$game2 = new Date(2015, 9, 25, 09, 30, 00, 00);
			$game3 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game4 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game5 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game6 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game7 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game8 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game9 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game10 = new Date(2015, 9, 25, 13, 00, 00, 00);
			$game11 = new Date(2015, 9, 25, 16, 05, 00, 00);
			$game12 = new Date(2015, 9, 25, 16, 25, 00, 00);
			$game13 = new Date(2015, 9, 25, 20, 30, 00, 00);
			$game14 = new Date(2015, 9, 26, 20, 30, 00, 00);
...
//show winner reconcile
		...
		?>
		   ...
		   <div class="container-fluid" id="week7_Picks">
		  	<div>
				<h3 style="font-family:Copperplate Gothic;margin-left:10px;float:left;">Week 7 Matchups</h3>
			</div>
			...
			<?php
				...
				echo "'>"; //validates
				echo "<input type='hidden' name='week_number' value='7'>";
			//Thursday matchups
				echo "<div id='thurs_games' style='clear:both;'>";
				echo "<h4><u>Thursday October 22, 2015</u></h4>";
				//game1
		...
		//Sunday matchups
				...
				echo "<h4><u>Sunday October 25, 2015</u></h4>";
				//game2
				echo '<div class="match" style="float:left">';
			...
			//Monday Matchups	
				...
				echo "<h4><u>Monday October 26, 2015</u></h4>";
				//game16
				echo '<div class="match" style="float:left">';
