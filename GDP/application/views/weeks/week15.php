<!-- picks week 15 -->
	...
	<script>
		$(function(){
			$d = new Date();
			$game1 = new Date(2015, 11, 17, 20, 25, 00, 00);
			$game2 = new Date(2015, 11, 19, 20, 25, 00, 00);
			$game3 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game4 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game5 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game6 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game7 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game8 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game9 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game10 = new Date(2015, 11, 20, 13, 00, 00, 00);
			$game11 = new Date(2015, 11, 20, 16, 05, 00, 00);
			$game12 = new Date(2015, 11, 20, 16, 05, 00, 00);
			$game13 = new Date(2015, 11, 20, 16, 25, 00, 00);
			$game14 = new Date(2015, 11, 20, 16, 25, 00, 00);
			$game15 = new Date(2015, 11, 20, 20, 30, 00, 00);
			$game16 = new Date(2015, 11, 21, 20, 30, 00, 00);
...
//show winner reconcile
		...
		?>
		   ...
		   <div class="container-fluid" id="week15_Picks">
		  	<div>
				<h3 style="font-family:Copperplate Gothic;margin-left:10px;float:left;">Week 15 Matchups</h3>
			</div>
			...
			<?php
				...
				echo "'>"; //validates
				echo "<input type='hidden' name='week_number' value='15'>";
		//Thursday matchups
				echo "<div id='thurs_games' style='clear:both;'>";
				echo "<h4><u>Thursday December 17, 2015</u></h4>";
				//game1
		...
		//Saturday matchups
				echo "<div id='sat_games' style='clear:both;'>";
				echo "<h4><u>Saturday December 19, 2015</u></h4>";
				//game2
				echo '<div class="match" style="float:left;">';
				...
				echo "</div>";//close saturday matchups

		//Sunday matchups
				echo "<div id='sun_games' style='clear:both;'>";
				echo "<h4><u>Sunday December 20, 2015</u></h4>";
				//game2
			...
			//Monday Matchups	
				...
				echo "<h4><u>Monday December 21, 2015</u></h4>";
				//game16
				echo '<div class="match" style="float:left">';
