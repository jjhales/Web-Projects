<!-- picks week 16 -->
	...
	<script>
		$(function(){
			$d = new Date();
			$game1 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game2 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game3 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game4 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game5 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game6 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game7 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game8 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game9 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game10 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game11 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game12 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game13 = new Date(2016, 0, 3, 13, 00, 00, 00);
			$game14 = new Date(2016, 0, 3, 16, 25, 00, 00);
			$game15 = new Date(2016, 0, 3, 16, 25, 00, 00);
			$game16 = new Date(2016, 0, 3, 16, 25, 00, 00);
...
//show winner reconcile
		...
		?>
		   ...
		   <div class="container-fluid" id="week17_Picks">
		  	<div>
				<h3 style="font-family:Copperplate Gothic;margin-left:10px;float:left;">Week 17 Matchups</h3>
			</div>
			...
			<?php
				...
				echo "'>"; //validates
				echo "<input type='hidden' name='week_number' value='17'>";
				//Sunday matchups
				echo "<div id='sun_games' style='clear:both;'>";
				echo "<h4><u>Sunday January 3, 2016</u></h4>";
				...
				echo '<button style="margin-left:15px;" id="picks_submit" class="btn btn-primary btn-lg" type="submit">Save</button>';
