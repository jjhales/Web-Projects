<!-- picks week 8 -->
<!-- The first Sunday game of the week is being played at 9:30 Am in London England.  Need to annotate this somehow! -->
	<style>
		body{
		max-width: 100%;
	...
	<script>	
			$(function(){
			$d = new Date();
			$game1 = new Date(2015, 9, 29, 20, 25, 00, 00);
			$game2 = new Date(2015, 10, 1, 09, 30, 00, 00);
			$game3 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game4 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game5 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game6 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game7 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game8 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game9 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game10 = new Date(2015, 10, 1, 13, 00, 00, 00);
			$game11 = new Date(2015, 10, 1, 16, 05, 00, 00);
			$game12 = new Date(2015, 10, 1, 16, 25, 00, 00);
			$game13 = new Date(2015, 10, 1, 20, 30, 00, 00);
			$game14 = new Date(2015, 10, 2, 20, 30, 00, 00);
...
//show winner reconcile
				...
				echo "$(function(){
							...
							$week_wins = ($win1 + $win2 + $win3 + $win4 + $win5 + $win6 + $win7 + $win8 + $win9 + $win10 + $win11 + $win12 + $win13 + $win14);
							$week_loss = ($loss1 + $loss2 + $loss3 + $loss4 + $loss5 + $loss6 + $loss7 + $loss8 + $loss9 + $loss10 + $loss11 + $loss12 + $loss13 + $loss14);
		...
		?>
		   ...
		   <div class="container-fluid" id="week8_Picks">
		  	<div>
				<h3 style="font-family:Copperplate Gothic;margin-left:10px;float:left;">Week 8 Matchups</h3>
			</div>
			...
			<?php
				...
				echo "'>"; //validates
				echo "<input type='hidden' name='week_number' value='8'>";
			//Thursday matchups
				echo "<div id='thurs_games' style='clear:both;'>";
				echo "<h4><u>Thursday October 29, 2015</u></h4>";
				//game1
		...
		//Sunday matchups
				...
				echo "<h4><u>Sunday November 1, 2015</u></h4>";
				//game2
				echo '<div class="match" style="float:left">';
			...
			//Monday Matchups	
				...
				echo "<h4><u>Monday November 2, 2015</u></h4>";
				//game16
				echo '<div class="match" style="float:left">';
