<!-- picks week 1 -->
	...
	<!-- disables radios if they are after game time -->
	<script>
//time lockout having issue when save after games have started blanks out other games
		$(function(){
			$d = new Date();
			$game1 = new Date(2015, 8, 10, 20, 30, 00, 00);
			$game2 = new Date(2015, 8, 13, 13, 00, 00, 00);
			$game3 = new Date(2015, 8, 13, 13, 00, 00, 00);
			$game4 = new Date(2015, 8, 13, 13, 00, 00, 00);
			$game5 = new Date(2015, 8, 13, 13, 00, 00, 00);
			$game6 = new Date(2015, 8, 13, 13, 00, 00, 00);
			$game7 = new Date(2015, 8, 13, 13, 00, 00, 00);
			$game8 = new Date(2015, 8, 13, 13, 00, 00, 00);
			$game9 = new Date(2015, 8, 13, 16, 05, 00, 00);
			$game10 = new Date(2015, 8, 13, 16, 25, 00, 00);
			$game11 = new Date(2015, 8, 13, 16, 25, 00, 00);
			$game12 = new Date(2015, 8, 13, 16, 25, 00, 00);
			$game13 = new Date(2015, 8, 13, 16, 25, 00, 00);
			$game14 = new Date(2015, 8, 13, 20, 30, 00, 00);
			$game15 = new Date(2015, 8, 14, 19, 10, 00, 00);
			$game16 = new Date(2015, 8, 14, 20, 20, 00, 00);
...
//show winner reconcile
		...
		?>
		   ...
		   <div class="container-fluid" id="week1_Picks">
			  	<div>
					<h3 style="font-family:Copperplate Gothic;margin-left:10px;float:left;">Week 1 Matchups</h3>
				</div>
			...
			<?php
				...
				echo "'>"; //validates
				echo "<input type='hidden' name='week_number' value='1'>";
			//Thursday matchups
				echo "<div id='thurs_games' style='clear:both;'>";
				echo "<h4><u>Thursday September 10, 2015</u></h4>";
				//game1
		...
		//Sunday matchups
				...
				echo "<h4><u>Sunday September 13, 2015</u></h4>";
				//game2
				echo '<div class="match" style="float:left;">';
			...
			//Monday Matchups	
				...
				echo "<h4><u>Monday September 14, 2015</u></h4>";
				//game15
				echo '<div class="match" style="float:left">';
