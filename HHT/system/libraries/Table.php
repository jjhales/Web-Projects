...
class CI_Table {
    ...
    {
        $args = func_get_args();
        $this->footer = (is_array($args[0])) ? $args[0] : $args;
    }
    ...
    function generate($table_data = NULL)
    {
        ...
        if (count($this->footer) > 0)
        {
            ...
            {
                $out .= $this->template['footer_cell_start'];
                $out .= $footer;
     ...
     */
     ...
     {     
        ...
        foreach (array('table_open','heading_row_start', 'heading_row_end', 'heading_cell_start', 'heading_cell_end', 'footer_row_start', 'footer_row_end', 'footer_cell_start', 'footer_cell_end', 'row_start', 'row_end', 'cell_start', 'cell_end', 'row_alt_start', 'row_alt_end', 'cell_alt_start', 'cell_alt_end', 'table_close') as $val)
        {
