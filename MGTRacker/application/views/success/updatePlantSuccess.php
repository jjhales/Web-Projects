    					...
    					<div class="modal-header">
        					<h4 class="modal-title" id="cropSucess">Review Grow Update</h4>
	     					...
	     					$this->load->helper('form');
								echo form_open('Crops/validatePlantGrow');
								echo '<div class="form-row"><div class="col">';
								echo form_label("Crop Number", "plantNumber");
								echo '</div><div class="col">';
								echo '<input type ="text" class="form-control form-control-plaintext" name = "plantNumber" value ="';
								echo $plantNumber;
								...
								echo form_submit("updateEnd", "Update" , "class='submit btn btn-primary'");
								?>
