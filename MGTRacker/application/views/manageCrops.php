...
//germination - update crops
	...
	foreach ($germination as $row) {
		...
		//Germination form
		echo form_open('Crops/updateGerm');
		echo '<div class="form-row"><div class="col">';
		echo form_label("Crop Number ", "flatNumber", 'class="form-control-sm"');
		echo '</div><div class="col">';
		echo '<input type ="text" class="form-control-sm form-control-plaintext" name = "flatNumber" value ="';
		echo $row->flatNumber;
		echo '"readonly"></div></div>';
		echo '<div class="form-row"><div class="col">';
		echo form_label("Seed Name ","seedName", 'class="form-control-sm"');
		echo '</div><div class="col">';
		echo '<input type ="text" class="form-control-sm form-control-plaintext" name = "seedName" value ="';
		echo $row->seedName;
		echo '"readonly"></div></div>';
		echo '<div class="form-row"><div class="col">';
		echo form_label("Light Date", "datelight", 'class="form-control-sm"');
		echo '</div><div class="col">';
		echo '<input type="date" class="form-control-sm " name="dateLight">';
		echo '</div></div>';
		echo '<div class="form-row"><div class="col">';
		echo form_label("Location ", "location", 'class="form-control-sm"');
		echo '</div><div class="col">';
		echo '<input type="text" class="form-control-sm" name="location" list="locations" placeholder="';
		echo $row->location;
		echo '">';
		echo '<datalist id="locations">';
		foreach($location as $row){
...
//grow - update crops
	...
	foreach ($grow as $row) {
		...
		echo '</div>';
		echo '" style="float:right;">details</button>';
		echo form_open('Crops/updateGrow');
		echo '<div class="form-row"><div class="col">';
		echo form_label("Crop Number ", "flatNumber", 'class="form-control-sm"');
		echo '</div><div class="col">';
		echo '<input type ="text" class="form-control-sm form-control-plaintext" name = "flatNumber" value ="';
